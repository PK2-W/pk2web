...
declare namespace PIXI {
    ...
    interface RendererOptions {
        ...
        /**
         * enables drawing buffer preservation, enable this if you need to call toDataUrl on the webgl _context [default=false]
         */
        preserveDrawingBuffer?: boolean;
        ...
        /**
         * Parameter passed to webgl _context, set to "high-performance" for devices with dual graphics card
         */
    ...
    namespace glCore {
        interface ContextOptions {
            ...
            preserveDrawingBuffer?: boolean;
            /**
             *  Boolean that indicates if a _context will be created if the system performance is low.
             */
    ...
    namespace utils {
        ...
        class EventEmitter {
             ...
             * @param {*} [context=this] The _context to invoke the listener with.
             ...
             * @param {*} context Only remove the listeners that have this _context.
