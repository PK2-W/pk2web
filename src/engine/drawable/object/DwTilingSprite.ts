...
export class DwTilingSprite extends DwObjectBase<DwContainer> {
    ...
    private _texture: PkImageTexture;
    
    public constructor(texture: PkImageTexture, width: number, height: number) {
    ...
    public get texture(): PkImageTexture {
        return this._texture;
    }
    public set texture(texture: PkImageTexture) {
        this._texture = texture;
        this.arrange();
    }
    public setTexture(texture: PkImageTexture): this {
        ...
        if (this._texture == null) {
            ...
            if (this._spriteBuffer.length > count) {
                ...
                while (this._spriteBuffer.length < count) {
                    this._spriteBuffer.push(DwFactory.new.sprite());
                }
            }
