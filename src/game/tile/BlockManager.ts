...
export class BlockManager {
    ...
    private calculateMovableBlocksPosition(): void {
        this.mCalculatedBlocks[BLOCK_HISSI_HORI].vasen = Math.floor(cos_table[degree % 360]);
        this.mCalculatedBlocks[BLOCK_HISSI_HORI].oikea = Math.floor(cos_table[degree % 360]);
        
        this.mCalculatedBlocks[BLOCK_HISSI_VERT].ala = Math.floor(sin_table[degree % 360]);
        this.mCalculatedBlocks[BLOCK_HISSI_VERT].yla = Math.floor(sin_table[degree % 360]);
