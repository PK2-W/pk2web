...
export class BlockPrototype {
    ...
    private _texture: NewTexture<PkPaletteBitmapResource>;
     ...
     */
    public static generatePrototypes(spritesheetTextures: NewTexture<PkPaletteBitmapResource>[]): BlockPrototype[] {
        ...
        for (let i = 0; i < 150; i++) {
            ...
            proto._code = i;
            proto._texture = spritesheetTextures[i];
    ...
    public get texture(): NewTexture<PkPaletteBitmapResource> {
