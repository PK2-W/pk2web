...
export class UIProgressBar extends PkUIComponent {
    private _width: number;
    private _height: number;
    private _color: t_color;
    
    private _progress: number;
    
    
    public constructor(context: PK2Context, x: number, y: number, width: number, height: number, color: t_color) {
