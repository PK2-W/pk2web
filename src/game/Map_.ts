...
export class PK2Kartta {
    ...
    public Count_Keys(): int {
        ...
        for (let x = 0; x < PK2KARTTA_KARTTA_KOKO; x++) {
            ...
            if (sprite !== 255)
            // if (PkEngine::Sprites->protot[sprite].avain &&
            // 	PkEngine::Sprites->protot[sprite].tuhoutuminen !== TUHOUTUMINEN_EI_TUHOUDU)
    ...
    public Select_Start(): void {
        ...
        // 	PkEngine::Sprites->player->x = pos_x + PkEngine::Sprites->player->tyyppi->leveys/2;
        // 	PkEngine::Sprites->player->y = pos_y - PkEngine::Sprites->player->tyyppi->korkeus/2;
        //
        // 	PkEngine::camera_x = (int)PkEngine::Sprites->player->x;
        // 	PkEngine::camera_y = (int)PkEngine::Sprites->player->y;
        // 	PkEngine::dcamera_x = PkEngine::camera_x;
        // 	PkEngine::dcamera_y = PkEngine::camera_y;
    }
